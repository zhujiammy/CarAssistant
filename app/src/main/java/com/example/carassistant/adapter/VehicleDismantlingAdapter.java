...
public class VehicleDismantlingAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public VehicleDismantlingAdapter(Context context,JsonArray model,int type){
