...
public class VehiclesNumberAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public VehiclesNumberAdapter(Context context,JsonArray model,int type){
