...
public class WarehouseCarsAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public WarehouseCarsAdapter(Context context,JsonArray model,int type){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.warehousecars_data, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if(viewHolder instanceof BodyViewHolder){
            ...
            if(!object.get("dismantleType").isJsonNull()){
                ((BodyViewHolder) viewHolder).dismantleType.setText(object.get("dismantleType").getAsString());
            }
            else {
                ((BodyViewHolder) viewHolder).dismantleType.setText("无");
            }
    ...
    public class BodyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView dismantleType;
        private LinearLayout line4,plateNumberNo_lin,chaijie;
        ...
        public BodyViewHolder(View itemView) {
            ...
            dismantleType = (TextView) itemView.findViewById(R.id.dismantleType);
            chaijie = (LinearLayout)itemView.findViewById(R.id.chaijie);
