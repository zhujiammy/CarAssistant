...
public class VehicleWeigAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public VehicleWeigAdapter(Context context,JsonArray model,int type){
