...
public class ProductionApprovalPreAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public ProductionApprovalPreAdapter(ProductionApprovalAty context,JsonArray model,int type){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.productionapprovalpre_data, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if(viewHolder instanceof BodyViewHolder){
            ...
            if(!object.get("disListCode").isJsonNull()){
                ((BodyViewHolder) viewHolder).disListCode.setText(object.get("disListCode").getAsString());
            }else {
                ((BodyViewHolder) viewHolder).disListCode.setText("无");
            }
            ...
            if(!object.get("partsNum").isJsonNull()){
                ((BodyViewHolder) viewHolder).partsNum.setText(object.get("partsNum").getAsString());
            }
            else {
                ((BodyViewHolder) viewHolder).partsNum.setText("无");
            }
            ...
            ((BodyViewHolder) viewHolder).Agree_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    context.print("确定审批同意吗？","1",object.get("disListId").getAsString());
                }
            });
            ...
            ((BodyViewHolder) viewHolder).refuse_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    context.print("确定拒绝审批吗？","2",object.get("disListId").getAsString());
                }
            });
...
/*            ((BodyViewHolder) viewHolder).checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    public class BodyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BodyViewHolder(View itemView) {
            super(itemView);
            disListCode = (TextView) itemView.findViewById(R.id.disListCode);
            remark = (TextView) itemView.findViewById(R.id.remark);
            partsNum = (TextView) itemView.findViewById(R.id.partsNum);
