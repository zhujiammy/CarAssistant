...
public class PartsWithdrawalAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public PartsWithdrawalAdapter(ProductionApprovalAty context,JsonArray model,int type){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if(viewHolder instanceof BodyViewHolder){
            ...
            if(!object.get("returnListCode").isJsonNull()){
                ((BodyViewHolder) viewHolder).disListCode.setText(object.get("returnListCode").getAsString());
            }else {
            ...
            if(!object.get("partNumber").isJsonNull()){
                ((BodyViewHolder) viewHolder).partsNum.setText(object.get("partNumber").getAsString());
            }
            else {
            ...
            ((BodyViewHolder) viewHolder).Agree_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    context.print("确定审批同意吗？","1",object.get("returnListId").getAsString());
                }
            });
            ...
            ((BodyViewHolder) viewHolder).refuse_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    context.print("确定拒绝审批吗？","2",object.get("returnListId").getAsString());
                }
            });
