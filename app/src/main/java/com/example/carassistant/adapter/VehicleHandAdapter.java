...
public class VehicleHandAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    int type = 1;
    public VehicleHandAdapter(Context context,JsonArray model,int type){
