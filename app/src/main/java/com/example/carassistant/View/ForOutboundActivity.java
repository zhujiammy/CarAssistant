...
//待出库车辆
public class ForOutboundActivity extends AppCompatActivity implements ForOutboundInterface.View, View.OnClickListener {
    ...
    private ForOutboundPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.foroutbound);
        ...
        initUI();
        presenter = new ForOutboundPresenter(this,this,recyclerView,adapter);
