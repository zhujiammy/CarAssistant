...
//待车辆初检
public class VehicleInspectionActivity extends AppCompatActivity implements VehicleInspectionInterface.View, View.OnClickListener {
    ...
    private VehicleInspectionPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehicleinspection);
        ...
        initUI();
        presenter = new VehicleInspectionPresenter(this,this,recyclerView,adapter);
