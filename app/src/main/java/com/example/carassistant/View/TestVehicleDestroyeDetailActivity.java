...
//试验车出库车辆毁型明细
public class TestVehicleDestroyeDetailActivity extends AppCompatActivity implements View.OnClickListener,NineGridView.onItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehicledestroyedetail);
    ...
    private void searchDestroyCarsDetails(){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcarsearchDestroyCarsDetails(Utils.getShared2(getApplicationContext(),"token"),getIntent().getStringExtra("carDetailId"));
    ...
    private void showdilgo(int type,String title){
        final AlertDialog.Builder alterDiaglog = new AlertDialog.Builder(TestVehicleDestroyeDetailActivity.this);
        ...
        alterDiaglog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                progressDialog = new ProgressDialog(TestVehicleDestroyeDetailActivity.this,
                ...
                if(files.size() != 0){
                    ...
                    Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcarsaveDestroyCars(Utils.getShared2(getApplicationContext(),"token"),getIntent().getStringExtra("carDetailId"),type,picAttachIds,parts);
                    call.enqueue(new Callback<ResponseBody>() {
                        @Override
                        public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                            if(response.body()!=null){
