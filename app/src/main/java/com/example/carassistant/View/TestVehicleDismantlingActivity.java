...
//试验车辆拆解
public class TestVehicleDismantlingActivity extends AppCompatActivity implements VehicleDismantlingInterface.View, View.OnClickListener {
    ...
    private TestVehicleDismantlingPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehicledismantling);
        ...
        initUI();
        presenter = new TestVehicleDismantlingPresenter(this,this,recyclerView,adapter);
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"205");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.getChooseDismantleTypeCars(data.get("carCode").getAsString());
