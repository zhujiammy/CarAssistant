...
//车辆拆解明细
public class DisassembleDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView remark;//备注
    @BindView(R.id.Thicksplit_btn)
    Button Thicksplit_btn;//粗拆
    @BindView(R.id.Bagopen_btn)
    Button Bagopen_btn;//包拆
    @BindView(R.id.Purehurt_btn)
    Button Purehurt_btn;//精拆
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.disassembledetail);
        ...
        if(getIntent().getStringExtra("type").equals("1")){
            ...
            storage_btn.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.qr) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                ...
                // 没有权限，申请权限。
                ActivityCompat.requestPermissions(DisassembleDetailActivity.this,new String[]{Manifest.permission.CAMERA},1);

            }else{
                Intent intent = new Intent(DisassembleDetailActivity.this, CaptureActivity.class);
    ...
    private void initEvent(){
        ...
        Thicksplit_btn.setOnClickListener(this);
        Bagopen_btn.setOnClickListener(this);
        Purehurt_btn.setOnClickListener(this);
    ...
    private void getChooseDismantleTypeCarsDetails(){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).getChooseDismantleTypeCarsDetails(Utils.getShared2(getApplicationContext(),"token"),getIntent().getStringExtra("carDetailId"));
    ...
    private void showdilgo(String type,String dictionaryCode){

            final AlertDialog.Builder alterDiaglog = new AlertDialog.Builder(DisassembleDetailActivity.this);
            alterDiaglog.setTitle("提示");//文字
            alterDiaglog.setMessage("确定"+type+"吗？");//提示消息
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(getIntent().getStringExtra("type").equals("1")){
                        if(warehouseId==null||warehouseId.equals("无")){
                            ...
                            progressDialog = new ProgressDialog(DisassembleDetailActivity.this,
                            ...
                            progressDialog.show();
                            Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).saveChooseDismantleType(Utils.getShared2(getApplicationContext(),"token"),getIntent().getStringExtra("carDetailId"),dictionaryCode,warehouseId);
                            call.enqueue(new Callback<ResponseBody>() {
                                @Override
                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                    if(response.body()!=null){
        ...
        if(requestCode == REQUEST_CODE){
            if(null != data){
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(DisassembleDetailActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    private void showWareHouseName(String result){
        ...
        call.enqueue(new Callback<ResponseBody>() {
                    ...
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                          ...
                          /*      int d= arrAdapterpay4.getCount();
                            ...
                            Toast.makeText(DisassembleDetailActivity.this,jsonObject.get("msg").getAsString(),Toast.LENGTH_LONG).show();
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(DisassembleDetailActivity.this,"连接超时，请检查网络环境，避免影响使用！",Toast.LENGTH_LONG).show();
