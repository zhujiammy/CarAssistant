...
import com.example.carassistant.Presenter.TestVehiclesNumberPresenter;
...
//试验车车辆拓号
public class TestVehiclesNumberActivity extends AppCompatActivity implements VehiclesNumberInterface.View, View.OnClickListener {
    ...
    private TestVehiclesNumberPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehiclesnumber);
        ...
        initUI();
        presenter = new TestVehiclesNumberPresenter(this,this,recyclerView,adapter);
        presenter.searchNeedPrintNoCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchNeedPrintNoCars(s.toString());
        }
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"201");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.searchNeedPrintNoCars(data.get("carCode").getAsString());
