...
import com.example.carassistant.Presenter.TestVehicleInspectionPresenter;
import com.example.carassistant.Presenter.VehicleInspectionPresenter;
...
//试验车初检
public class TestVehicleInspectionActivity extends AppCompatActivity implements VehicleInspectionInterface.View, View.OnClickListener {
    ...
    private TestVehicleInspectionPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehicleinspection);
        ...
        initUI();
        presenter = new TestVehicleInspectionPresenter(this,this,recyclerView,adapter);
        presenter.searchInitialSurveyCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchInitialSurveyCars(s.toString());
        }
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"203");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.searchInitialSurveyCars(data.get("carCode").getAsString());
