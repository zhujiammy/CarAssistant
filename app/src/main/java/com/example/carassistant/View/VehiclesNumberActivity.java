...
//车辆拓号
public class VehiclesNumberActivity extends AppCompatActivity implements VehiclesNumberInterface.View, View.OnClickListener {
    ...
    private VehiclesNumberPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehiclesbumber);
        ...
        initUI();
        presenter = new VehiclesNumberPresenter(this,this,recyclerView,adapter);
