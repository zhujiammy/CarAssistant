...
import com.example.carassistant.Presenter.VehiclesDismantledPresenter;
...
//车辆待确认拆解
public class VehiclesDismantledActivity extends AppCompatActivity implements VehiclesDismantledInterface.View, View.OnClickListener {
    ...
    private VehiclesDismantledPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehiclesdismantled);
        ...
        initUI();
        presenter = new VehiclesDismantledPresenter(this,this,recyclerView,adapter);
        presenter.searchDismantleConfirm(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchDismantleConfirm(s.toString());
        }
