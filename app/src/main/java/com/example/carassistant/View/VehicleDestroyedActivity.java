...
//车辆毁型
public class VehicleDestroyedActivity extends AppCompatActivity implements VehicleDestroyedInterface.View, View.OnClickListener {
    ...
    Toolbar toolbar;
    private VehicleDestroyedPresenter presenter;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        presenter = new VehicleDestroyedPresenter(this,this,recyclerView,adapter);
        presenter.searchDestroyCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchDestroyCars(s.toString());
        }
