...
//车源信息
public class CarSourceAdmissionActivity extends AppCompatActivity implements CarSourceAdmissionInterface.View, View.OnClickListener {
    ...
    private CarSourceAdmissionPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carsourceadmission);
        ...
        initUI();
        presenter = new CarSourceAdmissionPresenter(this,this,recyclerView,adapter);
        presenter.getDisCarsList(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.getDisCarsList(s.toString());
        }
