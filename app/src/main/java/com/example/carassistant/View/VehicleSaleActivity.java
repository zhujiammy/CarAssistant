...
import com.example.carassistant.Presenter.VehicleSalePresenter;
...
//车辆监销确认
public class VehicleSaleActivity extends AppCompatActivity implements VehicleSaleInterface.View, View.OnClickListener {
    ...
    private VehicleSalePresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehiclesale);
        ...
        initUI();
        presenter = new VehicleSalePresenter(this,this,recyclerView,adapter);
        presenter.superviseDestroysearchCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.superviseDestroysearchCars(s.toString());
        }
