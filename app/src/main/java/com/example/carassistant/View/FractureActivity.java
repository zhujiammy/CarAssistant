...
import com.example.carassistant.Presenter.FracturePresenter;
...
//待拆解破碎
public class FractureActivity extends AppCompatActivity implements FractureInterface.View, View.OnClickListener {
    ...
    private FracturePresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fractureactivity);
        ...
        initUI();
        presenter = new FracturePresenter(this,this,recyclerView,adapter);
        presenter.listWaitCrush(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.listWaitCrush(s.toString());
        }
