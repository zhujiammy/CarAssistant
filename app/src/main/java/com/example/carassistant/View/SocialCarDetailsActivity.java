...
public class SocialCarDetailsActivity extends AppCompatActivity implements HoldTabScrollView.OnHoldTabScrollViewScrollChanged {
...
/*        my_scrollview.setAdjustDistance(width,height);
    ...
    private void initUI(){
        ...
        ProcedureInfoFragment procedureInfoFragment = new ProcedureInfoFragment(viewPager);
        procedureInfoFragment.setArguments(bundle);
        ...
        mFragments.add(procedureInfoFragment);
    ...
    private void socialCarBaseInfo(){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).socialCarBaseInfo(Utils.getShared2(getApplicationContext(),"token"),carDetailId);
