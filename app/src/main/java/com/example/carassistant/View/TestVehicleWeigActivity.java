...
//试验车辆过磅
public class TestVehicleWeigActivity extends AppCompatActivity implements VehicleWeigInterface.View, View.OnClickListener {
    ...
    private TestVehicleWeigPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehicleweig);
        ...
        initUI();
        presenter = new TestVehicleWeigPresenter(this,this,recyclerView,adapter);
        presenter.searchWeighCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchWeighCars(s.toString());
        }
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"202");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.searchWeighCars(data.get("carCode").getAsString());
