...
import com.example.carassistant.Presenter.TestVehicleHandPresenter;
...
//试验车辆预处理
public class TestVehicleHandActivity extends AppCompatActivity implements VehicleHandInterface.View, View.OnClickListener {
    ...
    private TestVehicleHandPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testvehiclehand);
        ...
        initUI();
        presenter = new TestVehicleHandPresenter(this,this,recyclerView,adapter);
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"204");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.searchCarPretreatment(data.get("carCode").getAsString());
