...
//车辆过磅
public class VehicleWeigActivity extends AppCompatActivity implements VehicleWeigInterface.View, View.OnClickListener {
    ...
    private VehicleWeigPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehicleweig);
        ...
        initUI();
        presenter = new VehicleWeigPresenter(this,this,recyclerView,adapter);
