...
import com.example.carassistant.Presenter.ForOutboundPresenter;
import com.example.carassistant.Presenter.RetrieveVehiclePresenter;
import com.example.carassistant.Presenter.TestForOutboundPresenter;
...
//待出库试验车辆
public class TestForOutboundActivity extends AppCompatActivity implements ForOutboundInterface.View, View.OnClickListener {
    ...
    private TestForOutboundPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testforoutbound);
        ...
        initUI();
        presenter = new TestForOutboundPresenter(this,this,recyclerView,adapter);
        presenter.searchCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.searchCars(s.toString());
        }
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"208");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.searchCars(data.get("carCode").getAsString());
