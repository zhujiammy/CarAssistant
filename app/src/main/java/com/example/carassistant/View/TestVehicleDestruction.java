...
import com.example.carassistant.Presenter.TestVehicleDestroyedPresenter;
import com.example.carassistant.Presenter.VehicleDestroyedPresenter;
...
//试验车车辆毁型
public class TestVehicleDestruction extends AppCompatActivity implements TestVehicleDestroyedInterface.View, View.OnClickListener {
    ...
    Toolbar toolbar;
    private TestVehicleDestroyedPresenter presenter;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        setContentView(R.layout.vehicledestroyed);
        ...
        initUI();
        presenter = new TestVehicleDestroyedPresenter(this,this,recyclerView,adapter);
        presenter.testcarsearchDestroyCars(null);
    }
    ...
    TextWatcher watcher  = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            presenter.testcarsearchDestroyCars(s.toString());
        }
    ...
    private void testCarInfo(String result){
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testCarInfo(Utils.getShared2(getApplicationContext(),"token"),result,"209");
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            presenter.testcarsearchDestroyCars(data.get("carCode").getAsString());
