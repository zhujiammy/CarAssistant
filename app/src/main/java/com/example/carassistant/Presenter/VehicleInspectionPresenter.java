...
public class VehicleInspectionPresenter implements VehicleInspectionInterface.Presenter {
    public VehicleInspectionInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private VehiclesNumberAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public VehicleInspectionPresenter(VehicleInspectionInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,VehiclesNumberAdapter adapter){
        this.view = view;
    ...
    public void searchInitialSurveyCars(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).searchInitialSurveyCars(Utils.getShared2(context,"token"),searchInfo);
