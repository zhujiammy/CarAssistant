...
public class TestVehicleHandPresenter implements VehicleHandInterface.Presenter {
    public VehicleHandInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private VehicleHandAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public TestVehicleHandPresenter(VehicleHandInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,VehicleHandAdapter adapter){
        this.view = view;
    ...
    public void searchCarPretreatment(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcarsearchCarPretreatment(Utils.getShared2(context,"token"),searchInfo);
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            adapter = new VehicleHandAdapter(context,jsonElements,2);
