...
public class ForOutboundPresenter implements ForOutboundInterface.Presenter {
    public ForOutboundInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private ForOutboundAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public ForOutboundPresenter(ForOutboundInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,ForOutboundAdapter adapter){
        this.view = view;
    ...
    public void searchCars(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).searchCars(Utils.getShared2(context,"token"),searchInfo);
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            adapter = new ForOutboundAdapter(context,jsonElements,1);
