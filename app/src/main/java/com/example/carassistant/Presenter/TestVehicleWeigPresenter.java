...
public class TestVehicleWeigPresenter implements VehicleWeigInterface.Presenter {
    public VehicleWeigInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private VehicleWeigAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public TestVehicleWeigPresenter(VehicleWeigInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,VehicleWeigAdapter adapter){
        this.view = view;
    ...
    public void searchWeighCars(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcarsearchWeighCars(Utils.getShared2(context,"token"),searchInfo);
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            adapter = new VehicleWeigAdapter(context,jsonElements,2);
