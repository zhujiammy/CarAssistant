...
import com.example.carassistant.View.TestDisassembleDetailActivity;
...
public class TestVehicleDismantlingPresenter implements VehicleDismantlingInterface.Presenter {
    public VehicleDismantlingInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private VehicleDismantlingAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public TestVehicleDismantlingPresenter(VehicleDismantlingInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,VehicleDismantlingAdapter adapter){
        this.view = view;
    ...
    public void getChooseDismantleTypeCars(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcargetChooseDismantleTypeCars(Utils.getShared2(context,"token"),searchInfo);
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("status").getAsInt() == 0){
                            ...
                            adapter = new VehicleDismantlingAdapter(context,jsonElements,2);
                            adapter.setOnitemClickListener(new VehicleDismantlingAdapter.OnitemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    Intent intent = new Intent(context, TestDisassembleDetailActivity.class);
