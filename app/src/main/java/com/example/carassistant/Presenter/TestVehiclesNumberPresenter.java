...
public class TestVehiclesNumberPresenter implements VehiclesNumberInterface.Presenter {
    public VehiclesNumberInterface.View view;
    public Context context;
    JsonArray jsonElements;
    private VehiclesNumberAdapter adapter;
    RecyclerViewEmptySupport recyclerView;
    public TestVehiclesNumberPresenter(VehiclesNumberInterface.View view,Context context,RecyclerViewEmptySupport recyclerView,VehiclesNumberAdapter adapter){
        this.view = view;
    ...
    public void searchNeedPrintNoCars(String searchInfo) {
        Call<ResponseBody> call = HttpHelper.getInstance().create(CarAssistantAPI.class).testcarsearchNeedPrintNoCars(Utils.getShared2(context,"token"),searchInfo);
